...
namespace ProjectUtils.Helpers
{
    public static class Helpers 
    {
        ...
        /// </summary>
        public static Vector3[] GetBounds(float targetObjectScale = 1, float borderModification = 1, float targetObjectDistance = 0)
        {
        ...
        /// </summary>
        public static Vector3 GetRandomPointInBounds(float targetObjectScale = 1, float borderModification = 1, float distanceToTarget = 0)
        {
            Vector3[] bounds = GetBounds(targetObjectScale, borderModification, distanceToTarget);
