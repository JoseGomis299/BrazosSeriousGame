...
public class NetController : MonoBehaviour
{
    ...
    private async void Catch()
    {
        ...
        foreach (var bugCollider in bugs)
        {
            ...
            GameObject addition = ObjectPool.Instance.InstantiateFromPoolIndex(3, RectTransformUtility.WorldToScreenPoint(Helpers.Camera, bug.transform.position), Quaternion.identity, false);
