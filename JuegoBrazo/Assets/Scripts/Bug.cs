...
public class Bug : MonoBehaviour
{
    ...
    {
        _moveDirection = new Vector3(Random.Range(-5, 5), transform.position.y, Random.Range(-10, 10)) - transform.position;
    ...
    private void Update()
    {
        ...
        if(pos.x > _bounds.x || pos.x < _bounds.y || pos.z > _bounds.z || pos.z < _bounds.w) gameObject.SetActive(false);
    }
